...
module('Unit | Adapter | application', function(hooks) {
  ...
  test('should make the model name Rails-friendly', function(assert) {
    ...
    assert.strictEqual(adapter.pathForType('employmentOpportunity'), 'employment_opportunities');
    assert.strictEqual(adapter.pathForType('careerHistory'), 'career_histories');
  });
});
